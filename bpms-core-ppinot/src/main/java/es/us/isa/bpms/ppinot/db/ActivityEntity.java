...
public class ActivityEntity  {
	...
	// usuario que ejecuta la actividad
	 ...
	 * @param username Usuario que ejecuta la actividad
	 * @param startTime Momento de inicio
	 * @param endTime Momento en que finalizo
	 */
	public ActivityEntity(String processDefId, String instanceId, String executionId, String activityId, String activityName, String activityType, String username, Date startTime, Date endTime) {
